...
<title>__BASE__/__COUNTER__ &mdash; PrimeVault Rates</title>
...
<body>
  <h1>__BASE__/__COUNTER__ &mdash; PrimeVault Rates</h1>
  ...
  <div class="cards">
    <div class="card">
      ...
      <div class="value"><span id="quoted">&mdash;</span> <small style="font-size:13px;color:var(--muted)">__COUNTER__</small></div>
      <div class="footnote">__COUNTER__ per 1 __BASE__</div>
    </div>
    <div class="card">
      <div class="label">Mid-Market Rate</div>
      <div class="value"><span id="mid">&mdash;</span> <small style="font-size:13px;color:var(--muted)">__COUNTER__</small></div>
    ...
    <div class="card">
      ...
      <div class="footnote"><span id="spread_abs">&mdash;</span> __COUNTER__ absolute</div>
    </div>
    <div class="card">
  ...
  <div class="table-wrap">
    <table>
      <thead>
        <tr>
          <th>Timestamp (UTC)</th>
          <th>PrimeVault Quoted Rate (__COUNTER__)</th>
          <th>Mid-Market Rate (__COUNTER__)</th>
          <th>Spread (__COUNTER__)</th>
          <th>Spread %</th>
          <th>Spread bps</th>
        </tr>
      </thead>
  ...
  <div class="chart-wrap" style="margin-top:24px">
    <h2>__COUNTER__/__BASE__ Rates</h2>
